...
from standard.views import ModelsListView, ModelsDataView, ModelsView, PicsListView, PicsPartsListView, PicsPartsDataView, PicsPartsView, PicsDataView, PicsView
app_name = 'standard'
urlpatterns = [
