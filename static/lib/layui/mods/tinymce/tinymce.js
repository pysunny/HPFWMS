...
layui.define(['jquery'],function (exports) {
    ...
    t.render = function (option) {
        ...
        option.quickbars_insert_toolbar = option.quickbars_insert_toolbar ? option.quickbars_insert_toolbar : false;
        ...
        option.plugins = option.plugins ? option.plugins : 'lists advlist wordcount';

        option.toolbar = option.toolbar ? option.toolbar : 'undo redo | forecolor backcolor bold italic underline strikethrough subscript superscript | alignleft aligncenter alignright alignjustify | bullist numlist | formatselect fontselect fontsizeselect';
        ...
        option.contextmenu_never_use_native = false;

        // option.menubar = option.menubar ? option.menubar : 'file edit insert format table';
        option.menubar = option.menubar ? option.menubar : false;
        ...
        option.menu = option.menu ? option.menu : false;
